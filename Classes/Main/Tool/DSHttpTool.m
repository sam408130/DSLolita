...
- (NSArray *)showCommentFromAVObject:(NSArray *)objects{
    ...
    for (AVObject *object in objects){
        ...
        commentUser.name = [object objectForKey:@"commentUsername"];
        commentUser.profile_image_url = [object objectForKey:@"avatarUrl"];
